...
1. Clone this repository:
   ```bash
   git clone [https://github.com/M10Ziyad/Credit-Transfer-Course-Final_Project_MySql_Mongodb.git](https://github.com/M10Ziyad/Credit-Transfer-Course-Final_Project_MySql_Mongodb.git)
